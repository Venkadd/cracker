  ...
  return (
	...
	<div className="container pad">
		<div className="row">
			<div className="col-lg-12 col-md-12 col-12">
				<h1 className="cookie text-center text-white bigfont">About Us</h1>
			</div>
		</div>
	</div>
      </div>
    ...
    <div className="row">
        ...
        <div class="col-lg-6 col-md-6 col-12 pl-lg-4 pt-lg-0 pt-5">
            ...
            <p className="roboto">The History of  Crackers started by <strong>M.G.Raju</strong> in Tirunelveli, Tamil Nadu in 1985.
